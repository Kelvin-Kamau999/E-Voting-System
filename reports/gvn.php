...
<head>
    ...
    <title>GUBERNATORIAL ELECTION REPORTS</title>
</head>
<body class="profile">

     <center><p>THE NATIONAL ELECTION COMMISSION <br>GUBERNATORIAL ELECTION REPORT</p></center>
     <div>
     <p>After the general elections conducted on the <input type="text"> day of <input type="text">, <input type="text"> this is the final results tallied for the gubernaturial election.</p>
