...
<head>
    ...
    <title>WOMAN REP ELECTION REPORTS</title>
</head>
<body class="profile">

     <center><p>THE NATIONAL ELECTION COMMISSION <br>WOMAN REP ELECTION REPORT</p></center>
     <div>
     <p>After the general elections conducted on the <input type="text"> day of <input type="text">, <input type="text"> this is the final results tallied for the woman representative election.</p>
